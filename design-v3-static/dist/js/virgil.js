...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';__webpack_require__(2);var _jquery = __webpack_require__(
	1);var _jquery2 = babelHelpers.interopRequireDefault(_jquery);__webpack_require__(
	...
	__webpack_require__(4);__webpack_require__(
	5);
	...
	__webpack_require__(7);window.jQuery = _jquery2['default'];window.$ = _jquery2['default'];

	(0, _jquery2['default'])(document).on('ready', function () {
	  var $body = (0, _jquery2['default'])(window.document.body);
	  //let $win = $(window);
	  //let $header = $body.find('header');
	  //let scrolledHeaderClass = 'scrolled';
	  var $affixDocsMenu = (0, _jquery2['default'])('[data-ui="affix-docs"]');
	  var $affixDocsMenuPlaceholder = (0, _jquery2['default'])('[data-ui="menu-items-wrapper"]');
	  var affixDocsMenuInitialWidth = $affixDocsMenu.css('width');
	  var $affixDocsMenuTrigger = (0, _jquery2['default'])('[data-ui="affix-docs-trigger"]');
	  var extraTopOffset = 20;
	  var scrollToTarget = function scrollToTarget() {var href = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	    if (href) {
	      var target = (0, _jquery2['default'])(href);

	      if (target.length > 0) {
	        var targetOffsetTop = target.offset().top - extraTopOffset - 20;
	        (0, _jquery2['default'])('html, body').animate({ scrollTop: targetOffsetTop, easing: 'easeOutQuint' }, 500);} else 
	      {
	  ...
	  var $docMenu = $affixDocsMenuTrigger.find('ul').first();
	  if ($docMenu.length > 0) {
	    var $docMenuAppend = $docMenu.clone();
	  ...
	  $affixDocsMenu.affix({ 
	    offset: { 
	      top: function top() {return $affixDocsMenuTrigger.offset().top - extraTopOffset;}, 
	      bottom: parseInt((0, _jquery2['default'])('footer').css('height')) + 55 } });



	  $affixDocsMenu.on('affix.bs.affix', function () {
	    $affixDocsMenu.css({ 
	  ...
	  (0, _jquery2['default'])('.docs-content a[href^="#"], .docs-menu a[href^="#"]').on('click', function (e) {
	    e.preventDefault();
	    scrollToTarget((0, _jquery2['default'])(e.currentTarget).attr('href'));});


	  // patch the scrollspy to support not modified github docs
	  _jquery2['default'].fn.scrollspy.Constructor.prototype.refresh = function () {
	    ...
	    map(function () {
	      ...
	      var $href = /^#./.test(href) && (0, _jquery2['default'])('[id~="' + (href[0] === '#' ? href.replace('#', '') : href) + '"]');
	  ...
	  setTimeout(function () {
	    (0, _jquery2['default'])(document.body).scrollspy({ target: '.docs-menu a', offset: 200 });}, 
	  700);});
